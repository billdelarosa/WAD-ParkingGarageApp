...
public class MinMaxFeeCalculator implements FeeCalculatorStrategy {
    ...
    public MinMaxFeeCalculator(double minHours, double maxHours, double minFee, double maxFee, double hourlyFee) {
    ...
    public boolean equals(Object obj) {
        ...
        final MinMaxFeeCalculator other = (MinMaxFeeCalculator) obj;
