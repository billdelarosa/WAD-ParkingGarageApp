 ...
 * @author Billy-Mac
 */
public class testMinNoMaxFeeCalculator implements FeeCalculatorStrategy {
    ...
    public testMinNoMaxFeeCalculator() {
        setMinHours(2);
        setMinFee(1.5);
        setHourlyFee(0.75);
    }
    
    public testMinNoMaxFeeCalculator(int minHours, double minFee, double hourlyFee) {
